+++
title = "Configuration"
description = "Learn how to configure NekoBox."
weight = 2
sort_by = "weight"
...
NekoBox supports two proxy modes:

## System Proxy

Routes the entire system's traffic through the proxy by modifying system proxy settings.
