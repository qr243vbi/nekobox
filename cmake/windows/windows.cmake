...
if (MINGW)
	...
	# Generate .qrc file
	file(WRITE ${QRC_FILE} "<RCC>\n  <qresource prefix=\"/nekobox/public\">\n")
	...
	foreach(FILE_PATH IN LISTS QM_FILENAMES)
		# Make path relative to project root
		file(APPEND ${QRC_FILE} "    <file alias=\"${FILE_PATH}.qm\">${FILE_PATH}.qm</file>\n")
	endforeach()
	...
	file(APPEND ${QRC_FILE} "    <file alias=\"srslist.json\">${SRSLIST_PATH}</file>\n")
	file(APPEND ${QRC_FILE} "    <file alias=\"languages.txt\">${LANGUAGES_PATH}</file>\n")
